...
The purpose of Plot 1 is to explore differences in average self-regulation scores across counties and represent this geographically. A geographic heat map could be a useful way of quickly getting a sense of higher and lower scores across the state. The initial map looked like this: 
...
While this accomplished what I wanted it to functionally, it doesn't look very nice. The blue labels are difficult to read against this these scale colors. I tried out a few different palettes.    
...
This is getting closer to what I want. It uses a color-blind accessible palette, represents the sequential scale using colors that diverge from the middle, and allows us to read the labels clearly. 
