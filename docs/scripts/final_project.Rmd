...
```{r Viz #2 alternatives}

plot_2_b <- ggplot(d2, aes(avg_self_reg, stu_grp)) +
...
# tidying the 2013 and 2018 data sets in order to join them: 
...
join2 <- join2 %>%
  rename(avg_self_reg_2013 = avg_self_reg_county_firstwave,
         avg_self_reg_2018 = avg_self_reg)
