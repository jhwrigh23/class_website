...
join2 %>%
  ...
  labs(title = "Self Regulation Score Changes from 2014 to 2018",
       subtitle = "<span style = 'color:#00C2C6;'>2014</span> compared to <span style = 'color:#FF6C67;'>2018 </span>change.",
       x = NULL,
...
# Still soooooo many things to improve: 

1. Change the color of the lines to represent whether there was an increase or a decrease over time (thus highlighting counties that may need support in this domain)

2. fct_reorder by which counties showed the greatest improvements over time to the greatest decreases over time

3. Put "All counties" at the top and highlight as a reference point to show change state-wide? 

4. Refining: capitalizing county names, adjusting size and color 

*And the biggest problem:* 
I think 2014 and 2018 somehow got switched! Need to identify where this error occured.
...
### Also: 
- Taking the time to check: Why did this work? What did I figure out?
