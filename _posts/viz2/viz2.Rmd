...
d2 %>%
  ...
  labs(title = "Distributions of Self-Regulation Scores by Race in Oregon",
       subtitle = "Averages for 2018-2019 school year",
...
I refined what I thought was the most effective distribution plot further by changing the y-axis to proportion, making y-axis labels percentages, and adjusting the aspect ratio and layout: 

```{r preview= TRUE, vs2, layout="l-screen-inset", fig.width=13, fig.height=5}
...
Looking at this, though, I realized that it's pretty hard to compare the race groups when it's facet-wrapped. But I like using percent because that's more meaningful to a general audience. So I kept the code from the plot above, but removed the facet wrap and increased the transparency. 
