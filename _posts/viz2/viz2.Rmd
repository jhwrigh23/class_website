...
First, I plotted overall average scores by race. 
...
To gain more of a sense of the data, I also plotted distributions in a couple of difference ways.  
...
I'm not sure that this is the best way to represent differences in White vs Hispanic scores by county. If I stick with this plot, I need to tweak it to communicate that the  dots above 0.0 are counties in which Hispanic students score lower than White students, and the dots below 0.0 are counties in which White students score lower than Hispanic students.   
